...
export function Card({ trip, handleButtonCard }: TripProp) {
  const displayedDate = trip?.starts_at && trip?.ends_at
    ...
    : null;
  return (
    <article className="px-5 py-5 flex flex-col bg-zinc-900 shadow-shape items-start justify-between m-5">
      <div className="flex items-center justify-between w-full">
        <h2 className="text-2xl ml-auto">Viagem</h2>
        <button className="text-zinc-300 px-5 py-2 font-medium flex items-center gap-2">
